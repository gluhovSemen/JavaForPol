...
public class lab55 extends JFrame {
	...
	public lab55() {
        ...
        reportMenu.setText("Задания");
        memoryMenuItem1.setText("Задание 1");
        memoryMenuItem2.setText("Задание 2");
        memoryMenuItem3.setText("Задание 3");
        memoryMenuItem4.setText("Задание 4");
    ...
    private static void memoryMenuAction(int i)
    {
    	...
    	{case 1:  
    		...
    		go4.setVisible(false);
    		 ...
    		 go1.setVisible(true);
    	logInfo("Введите в верхнее окно число, операнд, число");
    	...
    	break;
    	  	case 2:  
        		...
        		window.add(go2, BorderLayout.PAGE_END);
    	  		go2.setVisible(true);
    	  		logInfo("Введите  в верхнее окно количество товаров,\n чтобы узнать сколько из них сожно подарить");
        	...
        	break;
    	  	case 4:  
        		...
        		go1.setVisible(false);
    	  		...
    	  		go4.setVisible(true);
    	  		logInfo("Введите  в верхнее окно количество потоков, \n потом количество строк "); 
    	  	//
        	break;
        }
    }
